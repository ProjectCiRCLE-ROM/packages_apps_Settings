 ...
 */
 package com.android.settings.circle.security
...
class UserSelectedAppSpoofSettings: Fragment(R.layout.hide_developer_status_layout) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profiles = resources.getStringArray(R.array.circle_spoof_profile_values)
        profileLabels = resources.getStringArray(R.array.circle_spoof_profile_labels)
    }
    ...
    private fun onListUpdate(packageName: String, profile: String?) {
        ...
        val stored = Settings.Secure.getString(
            ...
            Settings.Secure.CIRCLE_SPOOFED_APPS
        ) ?: ""
